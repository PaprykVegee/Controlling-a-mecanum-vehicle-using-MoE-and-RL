...
def generate_launch_description():
    ...
    gz_bridge = Node(
        ...
        arguments=[
            ...
            "/obstacle/touched@std_msgs/msg/Bool@gz.msgs.Boolean",
            "world/mecanum_drive/model/obstacle_box/link/link/sensor/contact_sensor/contact@ros_gz_interfaces/msg/Contacts[gz.msgs.Contacts"
        ],
        output='screen'
    )
